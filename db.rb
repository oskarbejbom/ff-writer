...
def ensure_teams(week)
  ...
  if( round.nil? )
    teams = Array.new
    teams << Team.new({:team_id => 57478, :name => "Oskar"})
    teams << Team.new({:team_id => 27056, :name => "Anders"}) 
    teams << Team.new({:team_id => 12250, :name => "Magnus"})
    teams << Team.new({:team_id => 11368, :name => "Robert"})
    teams << Team.new({:team_id => 1539322, :name => "Martin"})
