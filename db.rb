...
def ensure_teams(week)
  ...
  if( round.nil? )
    teams = Array.new
    teams << Team.new({:team_id => 22769, :name => "Oskar"})
    teams << Team.new({:team_id => 14778, :name => "Anders"}) 
    teams << Team.new({:team_id => 749, :name => "Magnus"})
    teams << Team.new({:team_id => 17417, :name => "Robert"})
    teams << Team.new({:team_id => 1756674, :name => "Martin"})
